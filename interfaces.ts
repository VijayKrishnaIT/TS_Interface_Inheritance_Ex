...
console.log(obj2.var_one, obj2.var_two, obj2.var_three); //Angular11 Deno Cassandra

class class_one implements interface1 {
    var_one: any = "Hello1";
    var_two: any = "Hello2";
    var_three: any = "Hello3"
}
const obj: class_one = new class_one();
console.log(obj.var_one, obj.var_two, obj.var_three); //Hello1 Hello2 Hello3
